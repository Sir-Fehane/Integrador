...
$db = new database();
$db->conectarDB();
$ordenesact = "SELECT DE.NO_ORDEN from DETALLE_ORDEN DE inner join ORDEN_VENTA OV ON OV.NO_ORDEN = DE.NO_ORDEN where DATE(OV.HORA_FECHA) = CURDATE()  AND DE.ESTADO='TERMINADA' group by DE.NO_ORDEN;";
...
$pdf->MultiCell(0,5,utf8_decode("Cajero: PENE DE PERRO"),0,'C',false);
$pdf->SetFont('Arial','B',10);
