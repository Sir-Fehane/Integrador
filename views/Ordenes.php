...
<div class="btn-group d-flex bg-light" role="group" style="overflow-x: auto; white-space: nowrap; width: 100%;">
    ...
    <a class="btn btn-primary flex-fill disabled" href="Ordenes.php" aria-disabled="true">Órdenes</a>
...
<?php
  ...
  $db = new Database();
  $db->conectarDB();
    echo "<h4 align='center'>Reporte de <strong>órdenes</strong> de todas las sucursales. ";
    echo
    "</h4>"; ?>
